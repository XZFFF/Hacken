...
--
-- Host: 127.0.0.1
-- Generation Time: 2018-04-06 16:52:21
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
CREATE TABLE IF NOT EXISTS `idea` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COMMENT='idea表' AUTO_INCREMENT=2 ;
...
(1, 1, 'Hacken', '一款帮助Hackathon参赛选手优质化快速化组队的Web产品', '前端*1 熟悉前端开发', 1, NULL, NULL, NULL, NULL, NULL, 0, '2018-04-06 14:42:49');
...
(1, 'xzfff', '202cb962ac59075b964b07152d234b70', '谢泽丰', 1, '后端开发', '123456', '567890', NULL, 0, 'PHP', 'MATLAB', NULL, NULL, NULL, NULL, NULL, '2018-04-06 13:15:23');
